...
5. Each player will get 3 wickets and 15 balls for batting and bowling.
...
if q.title()=="Bat": 
    ...
    while wickets<3 and balls<15:
        ...
        if n!=y and n in range(1,7):
            ...
            if wickets<1:
                e=total1
                scorecard1['Player1']=str(e)
            if wickets>=1 and wickets<2:
                f=total1-e
                scorecard1['Player2']=str(f)
            if wickets>=2 and wickets<3:
                g=total1-(e+f)
                scorecard1['Player3']=str(g)
        if n==y:
            wickets+=1
            balls+=1
            print("That\'s OUT!!!\n",total1,'-',wickets,'\n')
...
#2nd innings
    ...
    while wickets<3 and balls<15:
        ...
        if n!=y and n in range(1,7):
            ...
            if wickets<1:
                h=total2
                scorecard2['Player1']=str(h)
            if wickets<2 and wickets>=1:
                i=total2-h
                scorecard2['Player2']=str(i)
            if wickets<3 and wickets>=2:
                j=total2-(h+i)
                scorecard2['Player3']=str(j)
            if total2 > total1:
                break
        if n==y:
            wickets+=1
    ...
    print("Wickets\' individual score:\n",scorecard2)
    if total2>total1:
        print("Computer win by",3-wickets,'wickets with',15-balls,'balls to spare\nBetter Luck Next Time:(')
    if total2 < total1:
        print("You win by",total1-total2,'runs')
    if total2==total1:
        print("It\'s a tie")
    print("\n\n","*"*100)
...
#2nd innings
    ...
    print("Player\'s individual score:\n",scorecard2)
    if total2>total1:
        print("You win by",3-wickets,'wickets with',15-balls,'to spare')
    if total2 < total1:
        print("Computer win by",total1-total2,'runs\nBetter Luck Next Time:(')
    if total2==total1:
        print("It\'s a tie")
    print("\n\n","*"*100)    
